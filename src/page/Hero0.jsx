...
const Hero0 = () => {
  ...
  return (
      <div style={{
        ...
        className={' shadow-green-500 shadow-2xl xl:grid md:grid md:grid-cols-2  xl:grid-cols-4 grid  grid-cols-1 gap-16   items-center  absolute   p-4      sm:gap-5    text-center '}
      >
        <div style={{
          background: darkMode ? " black" : "",
          color: darkMode ? "white" : "",
